...
$to = 'info@teaching2fish.co.uk';
/*$to = 'pete.stump@gl13.net';*/

/* This will be appended to the subject of contact form message */

$subject_prefix = 'Contact via Website';
 ...
 * HTML tags. Write your message between <!-- Start message --> and <!-- End message --> */
 ...
 $thisDay = date("jS F",$localTime);
 $thisNow = date("g:i a",$localTime);
 
 $thank_you_message = <<<EOD
<!-- Start message -->
<p><strong>Thank you for your message sent at $thisNow on $thisDay - we will get back to you as soon as possible.</strong></p>
<!-- End message -->
EOD;
...
$subject = array('Phone','subject',NULL,NULL);
